...
import { MTablePagination, MTableSteppedPagination } from "material-table";
import { DragDropContext, Droppable } from "react-beautiful-dnd";
import DataManager from "./MatTableDataManager";
...
export default class MaterialTable extends React.Component {
  ...
  getColumnsWidth = (props, count) => {
    ...
    const actionsWidth = actionsColumnWidth(props);
    if (actionsWidth > 0) {
      if (
        count > 0 &&
